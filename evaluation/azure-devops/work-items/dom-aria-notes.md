# Azure DevOps – Work Items/Boards – DOM-/ARIA-Hypothesen
...
Pro Beobachtung am Markup/Accessibility Tree folgenden Block kopieren.
...
- Status: offene Hypothese | durch Test bestätigt (Bezug: AZ-WI-KB-### / AZ-WI-NV-###) | durch Test verworfen
```
